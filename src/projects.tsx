...
export const Artworks: Record<ProjectNamesEnum, Artwork[]> = {
  [ProjectNamesEnum.IN_PROGRESS]: [
    ...
    {
      images: ['/in-progress/2026-fairy-rock-bathers-ii.jpg'],
      title: 'Fairy rock bathers II',
      medium: 'oil monotype on Japanese paper',
      dimensions: '12.75x9.5"',
      available: true,
      purchaseLink: 'https://buy.stripe.com/4gM3co9M74Dd0362QTaAw0v',
      date: '2026-07-10',
    },
    {
      images: ['/in-progress/2026-canada-seascape.jpg'],
      title: 'Canada seascape',
      medium: 'oil on board',
      dimensions: '6x8"',
      available: true,
      purchaseLink: 'https://buy.stripe.com/cNiaEQgav9XxaHKezBaAw0u',
      date: '2026-07-10',
    },
    {
      images: ['/in-progress/2026-self-p-bird.jpg'],
      title: 'Self portrait, bird',
      medium: 'oil on board',
      dimensions: '12x9"',
      available: true,
      date: '2026-04-01',
  ...
  [ProjectNamesEnum.GSHI_2026]: [
    ...
    },
    {
      ...
      title: 'Duck by the curtain',
      medium: 'oil monotype on vellum',
      dimensions: '9.75x7.75"',
      available: true,
      date: '2026-01-01',
    ...
    },
    {
      ...
      title: 'Next, we swim',
      medium: 'oil monotype on cotton paper',
      dimensions: '8x9"',
      available: true,
      date: '2026-01-01',
  ...
  [ProjectNamesEnum.TREBOUL_2025]: [
    ...
    {
      images: ['/treboul/2025-12-cemetary.jpg'],
      title: 'Cemetery',
      medium: 'oil on board',
      dimensions: '12x9"',
      available: true,
    ...
    {
      images: ['/treboul/2025-12-Sables-blancs.jpeg'],
      title: 'Sables blancs',
      medium: 'oil on board',
      dimensions: '11x14"',
      available: true,
