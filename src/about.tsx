      ...
      <main className='flex-1 p-6 md:ml-6'>
        <div className='flex flex-col gap-y-4'>
          <div className='flex flex-col gap-y-2'>
            ...
            <p>
              Practice and enlightenment are one phenomenon – when we are
              present to the work, we can make art. I am drawn to intimate and
              quiet subject matter found in nature, in people I care about, in
              animals. I owe much of my growth as an artist to working alongside
              others.
            </p>
          </div>
